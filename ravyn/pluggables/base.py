...
from ravyn.core.protocols.extension import ExtensionProtocol
...
class Pluggable:
    ...
    Read more about the [Pluggables](https://ravyn.dev/pluggables/) and learn how to use them.
...
class Extension(ABC, ExtensionProtocol):
    ...
    Read more about the [Extension](https://ravyn.dev/pluggables/#extension) and learn how to use it.
    ...
    **Example**
    ...
    def __init__(
        ...
        app: Annotated[
            ...
            Doc(
                """
                An `Ravyn` application instance or subclasses of Ravyn.
                """
            ),
        ] = None,
        **kwargs: Annotated[
...
class ExtensionDict(dict[str, Extension]):
    def __init__(self, data: Any = None, *, app: Ravyn):
        super().__init__(data)
        self.app = app
