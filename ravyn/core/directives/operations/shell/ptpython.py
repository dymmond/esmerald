...
from ravyn.core.directives.operations.shell.utils import import_objects
...
def get_ptpython(app: typing.Any, options: typing.Any = None) -> typing.Any:
    ...
    Loads the initial configurations from the main ravyn settings
    ...
    try:
        ...
        error = "You must have PTPython installed to run this. Run `pip install ravyn[ipython]`"
