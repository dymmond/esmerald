...
from ravyn.core.directives.operations._constants import PATH
from ravyn.core.directives.utils import get_application_directives, get_directives
from ravyn.core.terminal import OutputColour, Terminal
...
def directives(env: DirectiveEnv) -> None:
    ...
    Goes through the Ravyn core native directives and given --app
    ...
    if getattr(env, "ravyn_app", None) is not None:
