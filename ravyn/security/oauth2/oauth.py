...
from ravyn.param_functions import Form
...
class OAuth2PasswordRequestForm(BaseModel):
    ...
    [Ravyn docs for Simple OAuth2 with Password and Bearer](https://ravyn.dev/tutorial/security/simple-oauth2/).
    ...
    from ravyn import Ravyn, Gateway, Inject, Injects, post
    from ravyn.security.oauth2 import OAuth2PasswordRequestForm
    ...
    def model_dump(self, **kwargs: Any) -> dict[str, Any]:
        ...
        as the scopes should be the one being used by Ravyn.
        """
        if kwargs is None:
            kwargs = {}
