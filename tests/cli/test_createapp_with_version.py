...
def test_create_app_with_env_var(create_folders):
    (o, e, ss) = run_cmd("tests.cli.main:app", "esmerald createproject --with-structure myproject")
    assert ss == 0

    os.chdir("myproject/myproject/apps")

    (o, e, ss) = run_cmd("tests.cli.main:app", "esmerald createapp myapp --version v10")
...
def test_create_app_without_env_var(create_folders):
    (o, e, ss) = run_cmd(
        "tests.cli.main:app", "esmerald createproject --with-structure myproject", is_app=False
    )
    assert ss == 0
    ...
    (o, e, ss) = run_cmd(
        "tests.cli.main:app", "esmerald createapp myapp --version v10", is_app=False
    )
...
def test_create_app_without_env_var_with_app_flag(create_folders):
    ...
    (o, e, ss) = run_cmd(
        "tests.cli.main:app",
        "esmerald --app tests.cli.main:app createapp myapp --version v10",
        is_app=False,
    )
