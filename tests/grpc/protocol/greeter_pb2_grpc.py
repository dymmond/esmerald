...
from tests.grpc.protocol import greeter_pb2 as greeter__pb2
...
def add_GreeterServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("test.Greeter", rpc_method_handlers)
