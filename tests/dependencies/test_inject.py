...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Factory("tests.dependencies.test_inject.async_fn"), "three-one"),
    ],
)
@pytest.mark.asyncio()
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Factory("tests.dependencies.test_inject.async_fn"), "three-one"),
        (Factory("tests.dependencies.test_inject.Test.async_class"), 31),
        (Factory("tests.dependencies.test_inject.Test.sync_class"), 31),
        (Factory("tests.dependencies.test_inject.Test.async_static"), "one-three"),
        (Factory("tests.dependencies.test_inject.Test.sync_static"), "one-three"),
        (Factory("tests.dependencies.test_inject.Test.InsideTest.async_class"), 56),
        (
            Factory("tests.dependencies.test_inject.Test.InsideTest.NestedInsideTest.async_class"),
            92,
        ),
    ],
)
