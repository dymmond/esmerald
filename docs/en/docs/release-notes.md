...
arise and therefore the decision to move away from it to bcrypt.

Unfortunataly this means that the `password` hashing will not be compatible with the previous versions of Esmerald and
